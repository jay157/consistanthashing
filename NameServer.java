...
public class NameServer implements Serializable  {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		nameServer.nsInfo = new NSInfo(id, listeningPort);
		do {
			...
			case "enter":
				...
				inputStream.close();
				socket.close();
				NSHandler thread = new NSHandler(nameServer);
				thread.start();
			...
			case "exit":
				...
				outputStream.writeObject("updateYourSuccessor");//send predessor the new successor
				...
				socket.close();
				int rangestart = nameServer.nsInfo.predessorId;
				int rangeEnd = nameServer.nsInfo.successorId==0?1023:nameServer.nsInfo.successorId;
				System.out.println("Key Range handed to "+nameServer.nsInfo.successorId+" : ["+rangestart+"-"+rangeEnd+"]");
