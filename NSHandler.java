...
public class NSHandler extends Thread implements Serializable  {
	...
	public NSHandler(NameServer nameServer) {
		  ...
		  while(true) {
			...
			//	System.out.println("Current command : "+nameServerDetailsStr[0]);
				...
				case "updateYourPredessorAndTakeAllKeys":
					...
					//System.out.println("Updated Information successorId" + nameServer.nsInfo.successorId);
